				...
				<div class="container">
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-6 logo"> <!-- логотип -->
							<div id="logoWithCorners">
								<div class="topRightCorner bigCorner corner"></div>
								<div class="topLeftCorner bigCorner corner"></div>
								<div class="bottomRightCorner bigCorner corner"></div>
								<div class="bottomLeftCorner bigCorner corner"></div>
								<div id="logoWrapper" class="py-1">
			...
			<div class="container">
				<div class="row pt-lg-5 pb-lg-5">
					<div class="col-lg-8 col-md-6 col-sm-4">
						<button id="travel">
							<div id="buttonWithCorners">
								<div class="topRightCorner smallCorner corner"></div>
								Начать путешествие
								<div class="bottomLeftCorner smallCorner corner"></div>
							</div>
						</button>
					</div>
